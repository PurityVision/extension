# ABOUT
Purity Vision Web Extension

A web extension for filtering impure images from whitelisted web pages.

Project forked from: [here](https://github.com/aeksco/react-typescript-web-extension-starter)
