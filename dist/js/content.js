...
var showPageImages = function () { getPageImages().forEach(function (img) { return img.classList.remove(IMPURE_IMG_CLASS); }); };
...
var hideImages = function (imgs) { return imgs.forEach(function (i) { return i.classList.add(IMPURE_IMG_CLASS); }); };
...
var showCleanImgs = function (res, imgs) {
    ...
    imgs
        ...
        .forEach(function (i) { i.classList.remove(IMPURE_IMG_CLASS); });
};
